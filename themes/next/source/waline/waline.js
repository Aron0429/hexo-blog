!(function (e, t) {
  ...
  Object.defineProperty(e, '__esModule', { value: !0 }),
    (e.version = e.pageviewCount = e.init = e.defaultLocales = e.commentCount = e.UserList = e.RecentComments = void 0)
    ...
    a = e => {
      const t = async function (t) {
        return fetch(
          ...
          .then(e => {
            let { data: t } = e
            return t.map(e => ({ title: e.title, src: e.images.downsized_medium.url }))
          })
      }
      return {
        ...
        more: function (e) {
          return t('search', {
            q: e,
            offset: (arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : 0).toString(),
          })
        },
      }
    },
  ...
  const k = {
    ...
    $ = e => {
      ...
      return fetch(
        `${t}/article?path=${encodeURIComponent(r.join(','))}&type=${encodeURIComponent(l.join(','))}&lang=${n}`,
        { signal: i },
      ).then(e => e.json())
    },
    C = e => {
    ...
    R = function () {
      return (arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : '').replace(/\/$/u, '')
    },
    E = e => /^(https?:)?\/\//.test(e),
    I = e => {
      const t = R(e)
  ...
  const D = T('itemscope,allowfullscreen,formnovalidate,ismap,nomodule,novalidate,readonly')
  function H(e) {
    return !!e || '' === e
  }
  function B(e, t) {
  ...
  const q = e =>
    ...
    ye = e => ue(e) && 'NaN' !== e && '-' !== e[0] && '' + parseInt(e, 10) === e,
    we = T(
  ...
  class qe {
    constructor(e) {
      ...
      ;(this.fn = e),
        ...
        (this.parent = void 0),
        (function (e) {
          let t = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : Oe
          ...
          (e => {
            ...
            if (t.length) {
              ...
              for (let r = 0; r < t.length; r++) {
                const l = t[r]
                Pe(l) && !Me(l) ? l.delete(e) : (t[n++] = l), (l.w &= ~Ve), (l.n &= ~Ve)
              }
              t.length = n
            }
          })(this),
    ...
    stop() {
      He === this ? (this.deferStop = !0) : this.active && (Ze(this), this.onStop && this.onStop(), (this.active = !1))
    }
  }
  function Ze(e) {
    const { deps: t } = e
  ...
  function Ye(e, t) {
    let n = !1
    Ne <= De ? Me(e) || ((e.n |= Ve), (n = !Pe(e))) : (n = !e.has(He)), n && (e.add(He), He.deps.push(e))
  }
  function et(e, t, n, r, l, i) {
    ...
    if ('clear' === t) s = [...o.values()]
      ...
      switch ((void 0 !== n && s.push(o.get(n)), t)) {
        case 'add':
          ie(e) ? ye(n) && s.push(o.get('length')) : (s.push(o.get(Be)), oe(e) && s.push(o.get(We)))
          break
        case 'delete':
  ...
  function ut() {
    ...
    return function (n, r, l) {
      ...
      if ('__v_raw' === r && l === (e ? (t ? Mt : Pt) : t ? Ut : Tt).get(n)) return n
      const i = ie(n)
      if (!e) {
      ...
      return (pe(r) ? lt.has(r) : rt(r))
        ? o
        : (e || Xe(n, 0, r), t ? o : Xt(o) ? (i && ye(r) ? o : o.value) : de(o) ? (e ? Nt(o) : Ft(o)) : o)
    }
  }
  function pt() {
    let e = arguments.length > 0 && void 0 !== arguments[0] && arguments[0]
    return function (t, n, r, l) {
      ...
      if (!e && (Bt(r) || Ht(r) || ((i = qt(i)), (r = qt(r))), !ie(t) && Xt(i) && !Xt(r))) return (i.value = r), !0
      const o = ie(t) && ye(n) ? Number(n) < t.length : le(t, n),
        s = Reflect.set(t, n, r, l)
      return t === qt(l) && (o ? Ae(r, i) && et(t, 'set', n, r) : et(t, 'add', n, r)), s
    }
  }
  const dt = {
      get: it,
  ...
  function yt(e) {
    ...
    const n = this.__v_raw,
      r = qt(n),
      l = qt(e)
    return t || (e !== l && Xe(r, 0, e), Xe(r, 0, l)), e === l ? n.has(e) : n.has(e) || n.has(l)
  }
  function wt(e) {
    let t = arguments.length > 1 && void 0 !== arguments[1] && arguments[1]
  ...
  function kt(e, t) {
    ...
    const o = l.call(n, e)
    return n.set(e, t), i ? Ae(t, o) && et(n, 'set', e, t) : et(n, 'add', e, t), this
  }
  function xt(e) {
    const t = qt(this),
      { has: n, get: r } = mt(t)
  ...
  function $t(e, t) {
    return function (n, r) {
      const l = this,
        ...
        o = qt(i),
        s = t ? gt : e ? Kt : Qt
      return !e && Xe(o, 0, Be), i.forEach((e, t) => n.call(r, s(e), s(t), l))
    }
  }
  function Ct(e, t, n) {
    return function () {
  ...
  const [At, Rt, Et, It] = (function () {
    ...
    return (
      ['keys', 'values', 'entries', Symbol.iterator].forEach(l => {
        ;(e[l] = Ct(l, !1, !1)), (n[l] = Ct(l, !0, !1)), (t[l] = Ct(l, !1, !0)), (r[l] = Ct(l, !0, !0))
      }),
      [e, n, t, r]
    )
  })()
  ...
  class nn {
    ...
    set value(e) {
      ...
      ;(e = t ? e : qt(e)), Ae(e, this._rawValue) && ((this._rawValue = e), (this._value = t ? e : Qt(e)), Jt(this))
    }
  }
  function rn(e) {
  ...
  function $n(e) {
    let t = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : dn ? gn + 1 : 0
    for (; t < fn.length; t++) {
      const e = fn[t]
  ...
  function Cn(e) {
    if (mn.length) {
      ...
      for (vn = e, vn.sort((e, t) => Sn(e) - Sn(t)), yn = 0; yn < vn.length; yn++) vn[yn]()
      ;(vn = null), (yn = 0)
    }
  }
  ...
  function Rn(e) {
    ...
    try {
      ...
      ;(gn = 0), (fn.length = 0), Cn(), (dn = !1), (bn = null), (fn.length || mn.length) && Rn()
    }
  }
  function En(e, t) {
  ...
  function In(e, t) {
    ...
    let i = {}
    return l
      ? (ie(l) ? l.forEach(e => (i[e] = null)) : te(i, l), de(e) && n.set(e, i), i)
      : (de(e) && n.set(e, null), null)
  }
  function Ln(e, t) {
    return (
      !(!e || !Y(t)) &&
      ((t = t.slice(2).replace(/Once$/, '')), le(e, t[0].toLowerCase() + t.slice(1)) || le(e, $e(t)) || le(e, t))
    )
  }
  let zn = null,
    On = null
  ...
  function Tn(e) {
    ...
    try {
      if (4 & n.shapeFlag) {
        ...
        const e = t
        ;(m = Xr(e.length > 1 ? e(i, { attrs: a, slots: s, emit: c }) : e(i, null))), (v = t.props ? a : Un(a))
      }
    } catch (t) {
    ...
    if (v && !1 !== g) {
      const e = Object.keys(v),
        { shapeFlag: t } = w
      e.length && 7 & t && (o && e.some(ee) && (v = Pn(v, o)), (w = Kr(w, v)))
    }
    return (
      n.dirs && ((w = Kr(w)), (w.dirs = w.dirs ? w.dirs.concat(n.dirs) : n.dirs)),
  ...
  function Hn(e, t) {
    ...
    if (
      (Xt(e)
        ...
        ? ((p = !0),
          ...
          (a = () => e.map(e => (Xt(e) ? e.value : Dt(e) ? Bn(e) : ce(e) ? cn(e, s, 2) : void 0))))
        : (a = ce(e)
            ? t
              ? () => cn(e, s, 2)
              : () => {
    ...
    if (cl) {
      if (((h = G), t ? n && un(t, s, 3, [a(), p ? [] : void 0, h]) : a(), 'sync' !== l)) return G
      {
        const e = ml()
      ...
      if (v.active)
        if (t) {
          ...
          ;(r || u || (p ? e.some((e, t) => Ae(e, f[t])) : Ae(e, f))) &&
            (c && c(), un(t, s, 3, [e, f === Vn ? void 0 : p && f[0] === Vn ? [] : f, h]), (f = e))
        } else v.run()
    }
    let m
    ;(g.allowRecurse = !!t),
    ...
    const v = new qe(a, m)
    t ? (n ? g() : (f = v.run())) : 'post' === l ? Sr(v.run.bind(v), s && s.suspense) : v.run()
    const y = () => {
      ...
      function (t) {
        return (
          ...
          (function (e, t) {
            ...
            arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : ll,
          )
        )
      },
    Kn = Qn('m'),
  ...
  function Xn(e, t) {
    ...
    for (let e = 0; e < t.length; e++) {
      ...
      n &&
        ...
        n.deep && Bn(i),
        l.push({ dir: n, instance: r, value: i, oldValue: void 0, arg: o, modifiers: s }))
    }
    return e
  }
  function Yn(e, t, n, r) {
  ...
  const lr = e => (e ? (al(e) ? dl(e) || e.proxy : lr(e.parent)) : null),
    ...
    sr = {
      get(e, t) {
        let { _: n } = e
        const { ctx: r, setupState: l, data: i, props: o, accessCache: s, type: a, appContext: c } = n
        let u
        if ('$' !== t[0]) {
          const e = s[t]
          if (void 0 !== e)
      ...
      set(e, t, n) {
        ...
        return or(i, t)
          ...
          : l !== Q && le(l, t)
          ? ((l[t] = n), !0)
          : !(le(r.props, t) || ('$' === t[0] && t.slice(1) in r) || ((o[t] = n), 0))
      },
      has(e, t) {
        let n,
          {
            _: { data: r, setupState: l, accessCache: i, ctx: o, appContext: s, propsOptions: a },
          } = e
        return (
          !!i[t] ||
          (r !== Q && le(r, t)) ||
      ...
      defineProperty(e, t, n) {
        return (
          null != n.get ? (e._.accessCache[t] = 0) : le(n, 'value') && this.set(e, t, n.value, null),
      ...
      for (let a in t) {
        ...
        l && le(l, (u = xe(a)))
          ? i && i.includes(u)
            ? ((o || (o = {}))[u] = c)
            : (n[u] = c)
          : Ln(e.emitsOptions, a) || (a in r && c === r[a]) || ((r[a] = c), (s = !0))
      }
    if (i) {
      const t = qt(n),
        r = o || Q
        ...
        if (pr(t)) {
          ...
          if (r) {
            const e = fr(Boolean, r.type),
              n = fr(String, r.type)
            ;(r[0] = e > -1), (r[1] = n < 0 || e < n), (e > -1 || le(r, 'default')) && o.push(t)
          }
        }
      }
    const s = [i, o]
  ...
  const gr = e => '_' === e[0] || '$stable' === e,
    ...
    vr = (e, t, n) => {
      if (t._n) return t
      const r = (function (e) {
        let t = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : zn
        if (!t) return e
        if (e._n) return e
        const n = function () {
          n._d && Mr(-1)
    ...
    kr = (e, t, n) => {
      ...
      if (32 & r.shapeFlag) {
        const e = t._
        e ? (n && 1 === e ? (i = !1) : (te(l, t), n || 1 !== e || delete l._)) : ((i = !t.$stable), yr(t, l)), (o = t)
    ...
    return function (n) {
      ...
      const s = (l.app = {
        ...
        use: function (e) {
          ...
          return i.has(e) || (e && ce(e.install) ? (i.add(e), e.install(s, ...n)) : ce(e) && (i.add(e), e(s, ...n))), s
        },
        mixin: e => s,
  ...
  function Cr(e, t, n, r) {
    ...
    if (ie(e)) return void e.forEach((e, i) => Cr(e, t && (ie(t) ? t[i] : t), n, r, l))
    if (qn(r) && !l) return
    const i = 4 & r.shapeFlag ? dl(r.component) || r.component.proxy : r.el,
      ...
      p = s.setupState
    if (
      (null != c && c !== a && (ue(c) ? ((u[c] = null), le(p, c) && (p[c] = null)) : Xt(c) && (c.value = null)), ce(a))
    )
      cn(a, s, 12, [o, u])
    else {
      const t = ue(a),
      ...
      if (t || r) {
        const s = () => {
          ...
          } else t ? ((u[a] = o), le(p, a) && (p[a] = o)) : r && ((a.value = o), e.k && (u[e.k] = o))
        }
        o ? ((s.id = -1), Sr(s, n)) : s()
      }
    }
  ...
  const Sr = function (e, t) {
    ...
    t && t.pendingBranch
      ? ie(e)
        ? t.effects.push(...e)
        : t.effects.push(e)
      : (ie((n = e)) ? mn.push(...n) : (vn && vn.includes(n, n.allowRecurse ? yn + 1 : yn)) || mn.push(n), _n())
  }
  function Ar(e) {
    return (function (e, t) {
      ze().__VUE__ = !0
      const {
          ...
          switch (c) {
            ...
            default:
              1 & p
                ...
                : 6 & p
                ? S(e, t, n, r, l, i, o, s, a)
                : (64 & p || 128 & p) && c.process(e, t, n, r, l, i, o, s, a, D)
          }
        ...
        y = (e, t, n, r, l, i, o, s, a) => {
          ;(o = o || 'svg' === t.type), null == e ? w(t, n, r, l, i, o, s, a) : x(e, t, l, i, o, s, a)
        },
        w = (e, t, r, o, s, a, u, p) => {
          let d, h
          ...
          if (
            ...
            8 & m ? c(d, e.children) : 16 & m && k(e.children, d, null, o, s, a && 'foreignObject' !== f, u, p),
            y && Yn(e, null, o, 'created'),
            b(d, e, e.scopeId, u, o),
            g)
          ) {
            for (const t in g) 'value' === t || we(t) || l(d, t, null, g[t], a, e.children, o, s, F)
            'value' in g && l(d, 'value', null, g.value), (h = g.onVnodeBeforeMount) && tl(h, o, e)
          }
          ...
          w && v.beforeEnter(d),
            ...
            ((h = g && g.onVnodeMounted) || w || y) &&
              Sr(() => {
                h && tl(h, o, e), w && v.enter(d), y && Yn(e, null, o, 'mounted')
              }, s)
        },
        b = (e, t, n, r, l) => {
        ...
        x = (e, t, n, r, i, o, s) => {
          ...
          if ((p ? _(e.dynamicChildren, p, a, n, r, m, o) : s || L(e, t, a, null, n, r, m, o, !1), u > 0)) {
            if (16 & u) $(a, t, h, f, n, r, i)
              ...
              for (let t = 0; t < o.length; t++) {
                const s = o[t],
                  c = h[s],
                  u = f[s]
                ;(u === c && 'value' !== s) || l(a, s, c, u, i, e.children, n, r, F)
              }
            }
        ...
        _ = (e, t, n, r, l, i, o) => {
          for (let s = 0; s < t.length; s++) {
            const a = e[s],
              c = t[s],
              p = a.el && (a.type === Ir || !Hr(a, c) || 70 & a.shapeFlag) ? u(a.el) : n
            f(a, c, p, null, r, l, i, o, !0)
          }
        },
        $ = (e, t, n, r, i, o, s) => {
          if (n !== r) {
            if (n !== Q) for (const a in n) we(a) || a in r || l(e, a, n[a], null, s, t.children, i, o, F)
            for (const a in r) {
              if (we(a)) continue
              const c = r[a],
                u = n[a]
              c !== u && 'value' !== a && l(e, a, u, c, s, t.children, i, o, F)
            }
        ...
        C = (e, t, r, l, i, s, a, c, u) => {
          ...
          g && (c = c ? c.concat(g) : g),
            null == e
              ...
              ? (_(e.dynamicChildren, f, r, i, s, a, c), (null != t.key || (i && t === i.subTree)) && Er(e, t, !0))
              : L(e, t, r, d, i, s, a, c, u)
        },
        S = (e, t, n, r, l, i, o, s, a) => {
          ;(t.slotScopeIds = s),
            null == e ? (512 & t.shapeFlag ? l.ctx.activate(t, n, r, o, a) : A(t, n, r, l, i, o, a)) : R(e, t, a)
        },
        A = (e, t, n, r, l, i, o) => {
          const s = (e.component = (function (e, t, n) {
            ...
            return (i.ctx = { _: i }), (i.root = t ? t.root : i), (i.emit = En.bind(null, i)), e.ce && e.ce(i), i
          })(e, r, l))
          if (
            ...
            (function (e) {
              ...
              ;(function (e, t, n) {
                ...
                const l = {},
                  i = {}
                Ee(i, Br, 1), (e.propsDefaults = Object.create(null)), ar(e, t, l, i)
                for (const t in e.propsOptions[0]) t in l || (l[t] = void 0)
                n ? (e.props = r ? l : Vt(l, !1, ft, Ot, Ut)) : e.type.props ? (e.props = l) : (e.props = i),
                  (e.attrs = i)
              })(e, n, l, t),
                br(e, r)
              l &&
                (function (e, t) {
                  const n = e.type
                  ;(e.accessCache = Object.create(null)), (e.proxy = Zt(new Proxy(e.ctx, sr)))
                  const { setup: r } = n
                  if (r) {
        ...
        R = (e, t, n) => {
          ...
          if (
            (function (e, t, n) {
              ...
              if (!(n && a >= 0)) return !((!l && !s) || (s && s.$stable)) || (r !== o && (r ? !o || Mn(r, o, c) : !!o))
              if (1024 & a) return !0
              ...
              () => {
                if (e.isMounted) {
                  ...
                  Rr(e, !1),
                    ...
                    r && Re(r),
                    (t = n.props && n.props.onVnodeBeforeUpdate) && tl(t, a, n, c),
                    Rr(e, !0)
                  const d = Tn(e),
                    h = e.subTree
                  ;(e.subTree = d),
                    ...
                    s && Sr(s, l),
                    (t = n.props && n.props.onVnodeUpdated) && Sr(() => tl(t, a, n, c), l)
                } else {
                  let o
                  const { el: s, props: a } = t,
                    ...
                    d = qn(t)
                  if (
                    (Rr(e, !1), c && Re(c), !d && (o = a && a.onVnodeBeforeMount) && tl(o, p, t), Rr(e, !0), s && B)
                  ) {
                    const n = () => {
                  ...
                  ;(256 & t.shapeFlag || (p && qn(p.vnode) && 256 & p.vnode.shapeFlag)) && e.a && Sr(e.a, l),
                    (e.isMounted = !0),
                    (t = n = r = null)
                }
              },
              ...
              if (!(r || o > 0) || 16 & o) {
                ...
                for (const i in s)
                  (t && (le(t, i) || ((r = $e(i)) !== i && le(t, r)))) ||
                    (a
                      ? !n || (void 0 === n[i] && void 0 === n[r]) || (l[i] = cr(a, s, i, void 0, e, !0))
                      : delete l[i])
                if (i !== s) for (const e in i) (t && le(t, e)) || (delete i[e], (c = !0))
              } else if (8 & o) {
        ...
        O = (e, t, n, r, l, i, o, s, a) => {
          ...
          if (c > p) {
            if (c <= d) {
              const e = d + 1,
                p = e < u ? t[e].el : r
              for (; c <= d; ) f(null, (t[c] = a ? Yr(t[c]) : Xr(t[c])), n, p, l, i, o, s, a), c++
            }
            ...
            for (c = h; c <= p; c++) {
              ...
              void 0 === u
                ? T(r, l, i, !0)
                : ((x[u - g] = c + 1), u >= k ? (k = u) : (b = !0), f(r, t[u], n, null, l, i, o, s, a), y++)
            }
            const _ = b
              ? (function (e) {
                  const t = e.slice(),
            ...
            for (v = _.length - 1, c = w - 1; c >= 0; c--) {
              const e = g + c,
                p = t[e],
                d = e + 1 < u ? t[e + 1].el : r
              0 === x[c] ? f(null, p, n, d, l, i, o, s, a) : b && (v < 0 || c !== _[v] ? j(p, n, d, 2) : v--)
            }
          }
        },
        j = function (e, t, r, l) {
          let i = arguments.length > 4 && void 0 !== arguments[4] ? arguments[4] : null
          const { el: o, type: s, transition: a, children: c, shapeFlag: u } = e
          if (6 & u) j(e.component.subTree, t, r, l)
            ...
            if (s !== Or)
              if (2 !== l && 1 & u && a)
                if (0 === l) a.beforeEnter(o), n(o, t, r), Sr(() => a.enter(o), i)
                else {
        ...
        T = function (e, t, n) {
          ...
          const { type: i, props: o, ref: s, children: a, dynamicChildren: c, shapeFlag: u, patchFlag: p, dirs: d } = e
          if ((null != s && Cr(s, null, n, e, !0), 256 & u)) return void t.ctx.deactivate(e)
          const h = 1 & u && d,
            f = !qn(e)
          let g
          if ((f && (g = o && o.onVnodeBeforeUnmount) && tl(g, t, e), 6 & u)) M(e.component, n, r)
          else {
        ...
        F = function (e, t, n) {
          let r = arguments.length > 3 && void 0 !== arguments[3] && arguments[3],
            l = arguments.length > 4 && void 0 !== arguments[4] && arguments[4]
          for (let i = arguments.length > 5 && void 0 !== arguments[5] ? arguments[5] : 0; i < e.length; i++)
            T(e[i], t, n, r, l)
        },
        N = e =>
          6 & e.shapeFlag ? N(e.component.subTree) : 128 & e.shapeFlag ? e.suspense.next() : p(e.anchor || e.el),
        V = (e, t, n) => {
          null == e ? t._vnode && T(t._vnode, null, null, !0) : f(t._vnode || null, e, t, null, null, null, n),
            $n(),
            Cn(),
            (t._vnode = e)
        },
        D = { p: f, um: T, m: j, r: U, mt: A, mc: k, pc: L, pbc: _, n: N, o: e }
      let H, B
  ...
  function Er(e, t) {
    ...
    if (ie(r) && ie(l))
      for (let e = 0; e < r.length; e++) {
        ...
        1 & i.shapeFlag &&
          !i.dynamicChildren &&
          ((i.patchFlag <= 0 || 32 === i.patchFlag) && ((i = l[e] = Yr(l[e])), (i.el = t.el)), n || Er(t, i)),
          i.type === Lr && (i.el = t.el)
      }
  }
  ...
  const Br = '__vInternal',
    ...
    qr = e => {
      ...
      return null != t ? (ue(t) || Xt(t) || ce(t) ? { i: zn, r: t, k: n, f: !!r } : t) : null
    }
  function Zr(e) {
    let t = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : null,
      ...
      l = arguments.length > 4 && void 0 !== arguments[4] ? arguments[4] : null,
      i = arguments.length > 5 && void 0 !== arguments[5] ? arguments[5] : e === Ir ? 0 : 1,
      o = arguments.length > 6 && void 0 !== arguments[6] && arguments[6],
    ...
    return (
      s ? (el(a, n), 128 & i && e.normalize(a)) : n && (a.shapeFlag |= ue(n) ? 8 : 16),
      Pr > 0 && !o && Tr && (a.patchFlag > 0 || 6 & i) && 32 !== a.patchFlag && Tr.push(a),
      a
    )
  }
  const Qr = function (e) {
    ...
    if (((e && e !== tr) || (e = zr), Dr(e))) {
      ...
      return (
        n && el(r, n),
        Pr > 0 && !i && Tr && (6 & r.shapeFlag ? (Tr[Tr.indexOf(e)] = r) : Tr.push(r)),
        (r.patchFlag |= -2),
        r
      )
    }
    ...
    if ((ce((o = e)) && '__vccOpts' in o && (e = e.__vccOpts), t)) {
      ...
      e && !ue(e) && (t.class = V(e)), de(n) && (Wt(n) && !ie(n) && (n = te({}, n)), (t.style = U(n)))
    }
    return Zr(
      e,
      t,
      ...
      r,
      l,
      ue(e) ? 1 : (e => e.__isSuspense)(e) ? 128 : (e => e.__isTeleport)(e) ? 64 : de(e) ? 4 : ce(e) ? 2 : 0,
      i,
      !0,
    )
  }
  function Kr(e, t) {
            ...
            for (let t = 0; t < arguments.length; t++) {
              ...
              for (const t in n)
                if ('class' === t) e.class !== n.class && (e.class = V([e.class, n.class]))
                  ...
                  const r = e[t],
                    l = n[t]
                  !l || r === l || (ie(r) && r.includes(l)) || (e[t] = r ? [].concat(r, l) : l)
                } else '' !== t && (e[t] = n[t])
            }
            return e
          })(r || {}, t)
    ...
    return {
      ...
      props: s,
      key: s && Wr(s),
      ref: t && t.ref ? (n && l ? (ie(l) ? l.concat(qr(t)) : [l, qr(t)]) : qr(t)) : l,
      scopeId: e.scopeId,
  ...
  function Jr() {
    let e = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : ''
    return arguments.length > 1 && void 0 !== arguments[1] && arguments[1] ? (Ur(), Vr(zr, null, e)) : Qr(zr, null, e)
  }
  function Xr(e) {
  ...
  function el(e, t) {
    ...
    if (null == t) t = null
      ...
      if (65 & r) {
        const n = t.default
        return void (n && (n._c && (n._d = !1), el(e, n()), n._c && (n._d = !0)))
      }
      {
        n = 32
        const r = t._
        r || Br in t
          ? 3 === r && zn && (1 === zn.slots._ ? (t._ = 1) : ((t._ = 2), (e.patchFlag |= 1024)))
          : (t._ctx = zn)
      }
    } else
      ce(t)
  ...
  function tl(e, t, n) {
    un(e, t, 7, [n, arguments.length > 3 && void 0 !== arguments[3] ? arguments[3] : null])
  }
  const nl = xr()
  let rl = 0,
    ll = null
  ...
  let cl = !1
  function ul(e, t, n) {
    ce(t) ? (e.type.__ssrInlineRender ? (e.ssrRender = t) : (e.render = t)) : de(t) && (e.setupState = on(t)), pl(e, n)
  }
  function pl(e, t, n) {
    const r = e.type
  ...
  const hl = (e, t) =>
    (function (e, t) {
      ...
      const i = ce(e)
      return i ? ((n = e), (r = G)) : ((n = e.get), (r = e.set)), new an(n, r, i || !r, l)
    })(e, 0, cl)
  function fl(e, t, n) {
    ...
    return 2 === r
      ? de(t) && !ie(t)
        ? Dr(t)
          ...
          : Qr(e, t)
        : Qr(e, null, t)
      : (r > 3 ? (n = Array.prototype.slice.call(arguments, 2)) : 3 === r && Dr(n) && (n = [n]), Qr(e, t, n))
  }
  const gl = Symbol(''),
    ml = () => Fn(gl),
    vl = '3.2.47',
    ...
    bl = {
      ...
      createElement: (e, t, n, r) => {
        const l = t ? yl.createElementNS('http://www.w3.org/2000/svg', e) : yl.createElement(e, n ? { is: n } : void 0)
  ...
  function xl(e, t, n) {
    if (ie(n)) n.forEach(n => xl(e, t, n))
      ...
      kl.test(n) ? e.setProperty($e(r), n.replace(kl, ''), 'important') : (e[r] = n)
    }
  }
  ...
  const Tl = {
      created(e, t, n) {
        ...
        Sl(e, r ? 'change' : 'input', t => {
          ...
          r || (Sl(e, 'compositionstart', Ol), Sl(e, 'compositionend', jl), Sl(e, 'change', jl))
      },
      mounted(e, t) {
        let { value: n } = t
        e.value = null == n ? '' : n
  ...
  const Ml = {
    ...
    Fl = {
      ...
      created(e, t, n) {
        ...
        const i = se(r)
        Sl(e, 'change', () => {
          const t = Array.prototype.filter.call(e.options, e => e.selected).map(e => (l ? Ie(Vl(e)) : Vl(e)))
  ...
  function Nl(e, t) {
    ...
    if (!n || ie(t) || se(t)) {
      for (let r = 0, l = e.options.length; r < l; r++) {
        ...
        else if (B(Vl(l), t)) return void (e.selectedIndex !== r && (e.selectedIndex = r))
      }
  ...
  const Wl = {
    beforeMount(e, t, n) {
      let { value: r } = t,
        { transition: l } = n
      ;(e._vod = 'none' === e.style.display ? '' : e.style.display), l && r ? l.beforeEnter(e) : ql(e, r)
    },
    mounted(e, t, n) {
      let { value: r } = t,
        { transition: l } = n
        ...
        'class' === t
          ...
          ? (function (e, t, n) {
              const r = e.style,
                l = ue(n)
              if (n && !l) {
                if (t && !ue(t)) for (const e in t) null == n[e] && xl(r, e, '')
          ...
          : (
              '.' === t[0]
                ...
                : (function (e, t, n, r) {
                    return r
                      ? 'innerHTML' === t || 'textContent' === t || !!(t in e && Ll.test(t) && ce(n))
                      : 'spellcheck' !== t &&
                          'draggable' !== t &&
                          'translate' !== t &&
                          'form' !== t &&
          ...
          ? (function (e, t, n, r, l, i, o) {
              ...
              if ('value' === t && 'PROGRESS' !== e.tagName && !e.tagName.includes('-')) {
                ...
                const r = null == n ? '' : n
                return (
                  (e.value === r && 'OPTION' !== e.tagName) || (e.value = r), void (null == n && e.removeAttribute(t))
                )
              }
              let s = !1
              if ('' === n || null == n) {
          ...
          : ('true-value' === t ? (e._trueValue = r) : 'false-value' === t && (e._falseValue = r),
            (function (e, t, n, r, l) {
              if (r && t.startsWith('xlink:'))
                null == n ? e.removeAttributeNS(Cl, t.slice(6, t.length)) : e.setAttributeNS(Cl, t, n)
              else {
                const r = D(t)
  ...
  var ri = Object.getOwnPropertySymbols,
    ...
    oi = (e, t) => {
      ...
      if (null != e && ri) for (var r of ri(e)) t.indexOf(r) < 0 && ii.call(e, r) && (n[r] = e[r])
      return n
    },
    ...
    hi = (e, t, n) => (t in e ? si(e, t, { enumerable: !0, configurable: !0, writable: !0, value: n }) : (e[t] = n)),
    fi = (e, t) => {
    ...
    mi = (e, t) => {
      ...
      if (null != e && ui) for (var r of ui(e)) t.indexOf(r) < 0 && di.call(e, r) && (n[r] = e[r])
      return n
    }
  function vi(e) {
    var t
  ...
  function bi() {
    ...
    if ((Jl(i[0]) || Array.isArray(i[0]) ? (([t, n, r] = i), (e = yi)) : ([e, t, n, r] = i), !e)) return Xl
          ...
          a(),
            r &&
              s.push(
                ...t.flatMap(e =>
                  n.map(t =>
                    ((e, t, n, r) => (e.addEventListener(t, n, r), () => e.removeEventListener(t, n, r)))(r, e, t, l),
                  ),
                ),
              )
        },
  ...
  var $i = Object.defineProperty,
    ...
    Ri = (e, t, n) => (t in e ? $i(e, t, { enumerable: !0, configurable: !0, writable: !0, value: n }) : (e[t] = n)),
    Ei = (e, t) => {
            ...
            try {
              if (null == t) n.removeItem(e)
                ...
                l !== r &&
                  ...
                  p &&
                    p.dispatchEvent(
                      new CustomEvent(Li, { detail: { key: e, oldValue: l, newValue: r, storageArea: n } }),
                    ))
              }
            } catch (e) {
              h(e)
        ...
        if (t && null == t.key) f.value = g
          ...
          try {
            f.value = (function (t) {
              ...
              if (!t && c) {
                const e = v.read(r)
                return Gl(c) ? c(e, g) : 'object' !== m || Array.isArray(e) ? e : Ei(Ei({}, g), e)
              }
  ...
  var Oi,
    ...
    Fi = (e, t, n) => (t in e ? Ti(e, t, { enumerable: !0, configurable: !0, writable: !0, value: n }) : (e[t] = n)),
    Ni = (e, t) => {
      for (var n in t || (t = {})) Pi.call(t, n) && Fi(e, n, t[n])
      if (Ui) for (var n of Ui(t)) Mi.call(t, n) && Fi(e, n, t[n])
      return e
    }
  ;((ji = Oi || (Oi = {})).UP = 'UP'), (ji.RIGHT = 'RIGHT'), (ji.DOWN = 'DOWN'), (ji.LEFT = 'LEFT'), (ji.NONE = 'NONE')
  let Vi = 0
  var Di = Object.defineProperty,
    Hi = Object.getOwnPropertySymbols,
    Bi = Object.prototype.hasOwnProperty,
    Wi = Object.prototype.propertyIsEnumerable,
    qi = (e, t, n) => (t in e ? Di(e, t, { enumerable: !0, configurable: !0, writable: !0, value: n }) : (e[t] = n))
  ;((e, t) => {
  ...
  const Zi = function (e) {
      ...
      return `${t ? `${t}/` : ''}${arguments.length > 2 && void 0 !== arguments[2] ? arguments[2] : ''}${e}${
        n ? `.${n}` : ''
      }`
    },
    Qi = e => {
    ...
    Ki = e => (e instanceof HTMLElement ? e : 'string' == typeof e ? document.querySelector(e) : null),
  ...
  function co(e, t) {
    ...
    const n = {
      replace: (t, r) => ((r = (r = r.source || r).replace(ao, '$1')), (e = e.replace(t, r)), n),
  ...
  function ho(e, t, n) {
    ...
    t &&
      !po.test(n) &&
      (n = (function (e, t) {
        fo[' ' + e] || (go.test(e) ? (fo[' ' + e] = e + '/') : (fo[' ' + e] = ko(e, '/', !0)))
  ...
  function $o(e, t, n, r) {
    ...
    if ('!' !== e[0].charAt(0)) {
      r.state.inLink = !0
      const e = { type: 'link', raw: n, href: l, title: i, text: o, tokens: r.inlineTokens(o) }
  ...
  class Co {
    ...
    code(e) {
      ...
      if (t) {
        ...
        return { type: 'code', raw: t[0], codeBlockStyle: 'indented', text: this.options.pedantic ? e : ko(e, '\n') }
      }
    }
    fences(e) {
    ...
    list(e) {
      ...
      if (t) {
        ...
        for (; e && ((h = !1), (t = v.exec(e))) && !this.rules.block.hr.test(e); ) {
          if (
            ...
            this.options.pedantic
              ? ((i = 2), (d = c.trimLeft()))
              : ((i = t[2].search(/[^ ]/)), (i = i > 4 ? 1 : i), (d = c.slice(i)), (i += t[1].length)),
            (s = !1),
          ...
          m.loose || (a ? (m.loose = !0) : /\n *\n *$/.test(n) && (a = !0)),
            this.options.gfm &&
              ((r = /^\[[ xX]\] /.exec(d)), r && ((l = '[ ] ' !== r[0]), (d = d.replace(/^\[[ xX]\] +/, '')))),
        ...
        for (o = 0; o < y; o++)
          if (
            ((this.lexer.state.top = !1), (m.items[o].tokens = this.lexer.blockTokens(m.items[o].text, [])), !m.loose)
          ) {
    ...
    html(e) {
      ...
      if (t) {
        ...
        if (this.options.sanitize) {
          const n = this.options.sanitizer ? this.options.sanitizer(t[0]) : io(t[0])
        ...
        if (e.header.length === e.align.length) {
          ...
          for (n = 0; n < o; n++)
            /^ *-+: *$/.test(e.align[n])
              ...
              ? (e.align[n] = 'left')
              : (e.align[n] = null)
          for (o = e.rows.length, n = 0; n < o; n++) e.rows[n] = bo(e.rows[n], e.header.length).map(e => ({ text: e }))
      ...
      if (t)
        return (
              ...
              (this.lexer.state.inRawBlock = !1),
          {
            ...
            text: this.options.sanitize ? (this.options.sanitizer ? this.options.sanitizer(t[0]) : io(t[0])) : t[0],
          }
        )
    }
    link(e) {
    ...
    codespan(e) {
      ...
      if (t) {
        ...
        const n = /[^ ]/.test(e),
          r = /^ /.test(e) && / $/.test(e)
        return n && r && (e = e.substring(1, e.length - 1)), (e = io(e, !0)), { type: 'codespan', raw: t[0], text: e }
      }
    }
    br(e) {
    ...
    autolink(e, t) {
      ...
      if (n) {
        ...
        return (
          '@' === n[2]
            ? ((e = io(this.options.mangle ? t(n[1]) : n[1])), (r = 'mailto:' + e))
            : ((e = io(n[1])), (r = e)),
    ...
    url(e, t) {
      ...
      if ((n = this.rules.inline.url.exec(e))) {
        let e, r
        if ('@' === n[2]) (e = io(this.options.mangle ? t(n[0]) : n[0])), (r = 'mailto:' + e)
        else {
          let t
          do {
  ...
  ;(So.def = co(So.def).replace('label', So._label).replace('title', So._title).getRegex()),
    (So.bullet = /(?:[*+-]|\d{1,9}[.)])/),
    ...
    (So.paragraph = co(So._paragraph)
      ...
      .replace('tag', So._tag)
      .getRegex()),
    (So.blockquote = co(So.blockquote).replace('paragraph', So.paragraph).getRegex()),
    (So.normal = wo({}, So)),
    (So.gfm = wo({}, So.normal, {
      table:
  ...
  ;(Ao._punctuation = '!"#$%&\'()+\\-.,/:;<=>?@\\[\\]`^{|}~'),
    ...
    (Ao.blockSkip = /\[[^\]]*?\]\([^\)]*?\)|`[^`]*?`|<[^>]*?>/g),
    (Ao.escapedEmSt = /(?:^|[^\\])(?:\\\\)*\\[*_]/g),
    (Ao._comment = co(So._comment).replace('(?:--\x3e|$)', '--\x3e').getRegex()),
    (Ao.emStrong.lDelim = co(Ao.emStrong.lDelim).replace(/punct/g, Ao._punctuation).getRegex()),
    (Ao.emStrong.rDelimAst = co(Ao.emStrong.rDelimAst, 'g').replace(/punct/g, Ao._punctuation).getRegex()),
    (Ao.emStrong.rDelimUnd = co(Ao.emStrong.rDelimUnd, 'g').replace(/punct/g, Ao._punctuation).getRegex()),
    (Ao._escapes = /\\([!"#$%&'()*+,\-./:;<=>?@\[\]\\^_`{|}~])/g),
    (Ao._scheme = /[a-zA-Z][a-zA-Z0-9+.-]{1,31}/),
    (Ao._email =
      /[a-zA-Z0-9.!#$%&'*+/=?^_`{|}~-]+(@)[a-zA-Z0-9](?:[a-zA-Z0-9-]{0,61}[a-zA-Z0-9])?(?:\.[a-zA-Z0-9](?:[a-zA-Z0-9-]{0,61}[a-zA-Z0-9])?)+(?![-_])/),
    (Ao.autolink = co(Ao.autolink).replace('scheme', Ao._scheme).replace('email', Ao._email).getRegex()),
    (Ao._attribute = /\s+[a-zA-Z:_][\w.:-]*(?:\s*=\s*"[^"]*"|\s*=\s*'[^']*'|\s*=\s*[^\s"'=<>`]+)?/),
    (Ao.tag = co(Ao.tag).replace('comment', Ao._comment).replace('attribute', Ao._attribute).getRegex()),
    (Ao._label = /(?:\[(?:\\.|[^\[\]\\])*\]|\\.|`[^`]*`|[^\[\]\\`])*?/),
    (Ao._href = /<(?:\\.|[^\n<>\\])+>|[^\s\x00-\x1f]*/),
    (Ao._title = /"(?:\\"?|[^"\\])*"|'(?:\\'?|[^'\\])*'|\((?:\\\)?|[^)\\])*\)/),
    (Ao.link = co(Ao.link)
      ...
      .getRegex()),
    (Ao.reflink = co(Ao.reflink).replace('label', Ao._label).replace('ref', So._label).getRegex()),
    ...
    (Ao.gfm.url = co(Ao.gfm.url, 'i').replace('email', Ao.gfm._extended_email).getRegex()),
    (Ao.breaks = wo({}, Ao.gfm, {
  ...
  class Io {
    constructor(e) {
      ...
      this.options.pedantic
        ...
        : this.options.gfm && ((t.block = So.gfm), this.options.breaks ? (t.inline = Ao.breaks) : (t.inline = Ao.gfm)),
        ...
        if (
          !(
            ...
            this.options.extensions.block.some(
              n => !!(t = n.call({ lexer: this }, e, i)) && ((e = e.substring(t.raw.length)), i.push(t), !0),
            )
          )
        )
          if ((t = this.tokenizer.space(e)))
            (e = e.substring(t.raw.length)),
              1 === t.raw.length && i.length > 0 ? (i[i.length - 1].raw += '\n') : i.push(t)
            ...
            if (((r = e), this.options.extensions && this.options.extensions.startBlock)) {
              ...
              this.options.extensions.startBlock.forEach(function (e) {
                ;(l = e.call({ lexer: this }, n)), 'number' == typeof l && l >= 0 && (t = Math.min(t, l))
              }),
    ...
    inlineTokens(e) {
      ...
      for (; null != (l = this.tokenizer.rules.inline.escapedEmSt.exec(a)); )
        (a = a.slice(0, l.index + l[0].length - 2) + '++' + a.slice(this.tokenizer.rules.inline.escapedEmSt.lastIndex)),
        ...
        if (
          ...
          !(
            ...
            this.options.extensions.inline.some(
              n => !!(t = n.call({ lexer: this }, e, s)) && ((e = e.substring(t.raw.length)), s.push(t), !0),
            )
          ))
        )
          if ((t = this.tokenizer.escape(e))) (e = e.substring(t.raw.length)), s.push(t)
            ...
            (e = e.substring(t.raw.length)),
              (n = s[s.length - 1]),
              n && 'text' === t.type && 'text' === n.type ? ((n.raw += t.raw), (n.text += t.text)) : s.push(t)
          ...
          else if ((t = this.tokenizer.autolink(e, Eo))) (e = e.substring(t.raw.length)), s.push(t)
  ...
  class Lo {
    ...
    code(e, t, n) {
      ...
      return (
        (e = e.replace(/\n$/, '') + '\n'),
        r
          ? '<pre><code class="' + this.options.langPrefix + io(r) + '">' + (n ? e : io(e, !0)) + '</code></pre>\n'
    ...
    link(e, t, n) {
      if (null === (e = ho(this.options.sanitize, this.options.baseUrl, e))) return n
      let r = '<a href="' + e + '"'
          ...
          switch (u.type) {
            ...
            case 'table':
              for (a = '', s = '', l = u.header.length, n = 0; n < l; n++)
                s += this.renderer.tablecell(this.parseInline(u.header[n].tokens), { header: !0, align: u.align[n] })
              for (a += this.renderer.tablerow(s), c = '', l = u.rows.length, n = 0; n < l; n++) {
                for (o = u.rows[n], s = '', i = o.length, r = 0; r < i; r++)
                  s += this.renderer.tablecell(this.parseInline(o[r].tokens), { header: !1, align: u.align[r] })
            ...
            case 'blockquote':
              ...
              continue
            case 'list':
              for (p = u.ordered, d = u.start, h = u.loose, l = u.items.length, c = '', n = 0; n < l; n++)
                (g = u.items[n]),
                  (m = g.checked),
                  (v = g.task),
                  (f = ''),
  ...
  function To(e, t, n) {
    ...
    if (('function' == typeof t && ((n = t), (t = null)), xo((t = wo({}, To.defaults, t || {}))), n)) {
      const r = t.highlight
      let l
      try {
        l = Io.lex(e, t)
      ...
      const i = function (e) {
        ...
        if (!e)
          try {
            t.walkTokens && To.walkTokens(l, t.walkTokens), (i = jo.parse(l, t))
          } catch (t) {
            e = t
          }
    ...
    function r(e) {
      if (((e.message += '\nPlease report this to https://github.com/markedjs/marked.'), t.silent))
        return '<p>An error occurred:</p><pre>' + io(e.message + '', !0) + '</pre>'
      throw e
    }
    try {
      const n = Io.lex(e, t)
  ...
  ;(To.options = To.setOptions =
      ...
      n.forEach(t => {
        ...
        if (t.walkTokens) {
          ...
          n.walkTokens = function (n) {
            let r = []
            return r.push(t.walkTokens.call(this, n)), e && (r = r.concat(e.call(this, n))), r
          }
        }
        To.setOptions(n)
      })
    ...
    (To.walkTokens = function (e, t) {
      ...
      for (const r of e)
        switch (((n = n.concat(t.call(To, r))), r.type)) {
          case 'table':
            for (const e of r.header) n = n.concat(To.walkTokens(e.tokens, t))
            for (const e of r.rows) for (const r of e) n = n.concat(To.walkTokens(r.tokens, t))
            break
          case 'list':
            n = n.concat(To.walkTokens(r.items, t))
            break
          default:
            To.defaults.extensions && To.defaults.extensions.childTokens && To.defaults.extensions.childTokens[r.type]
              ? To.defaults.extensions.childTokens[r.type].forEach(function (e) {
    ...
    (To.parseInline = function (e, t) {
      ...
      try {
        ...
        return t.walkTokens && To.walkTokens(n, t.walkTokens), jo.parseInline(n, t)
      } catch (e) {
        if (((e.message += '\nPlease report this to https://github.com/markedjs/marked.'), t.silent))
          return '<p>An error occurred:</p><pre>' + io(e.message + '', !0) + '</pre>'
        throw e
  ...
  const Uo = /\$.*?\$/,
    ...
    Fo = function () {
      ...
      return (arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : '').replace(/:(.+?):/g, (t, n) =>
      ...
      return (
        o.length &&
          (e => {
            ...
            return fetch(`${t}/comment?type=count&url=${encodeURIComponent(r.join(','))}&lang=${n}`, { signal: l })
              .then(e => e.json())
              .then(e => (Array.isArray(e) ? e : [e]))
          })({
            serverURL: I(t),
            paths: Array.from(o).map(e => A(e.dataset.path || e.getAttribute('id') || n)),
            lang: l,
            signal: i.signal,
          })
            .then(e => {
    ...
    Do = e => {
      let { size: t } = e
      return fl('svg', { class: 'wl-close-icon', viewBox: '0 0 1024 1024', width: t, height: t }, [
        fl('path', {
    ...
    qo = e => {
      let { active: t = !1 } = e
      return fl('svg', { viewBox: '0 0 1024 1024', width: '24', height: '24' }, [
        fl('path', {
          d:
    ...
    Yo = () =>
      fl('svg', { width: 24, height: 24, fill: 'currentcolor', viewBox: '0 0 24 24' }, [
        fl('path', {
  ...
  Object.defineProperty(os, '__esModule', { value: !0 }), (os.ReCaptchaInstance = void 0)
  var cs = (function () {
    function e(e, t, n) {
      ...
      setup(e, t) {
        ...
        const r = ns ?? (ns = zi('WALINE_REACTION', {})),
          ...
          c = hl(() => {
            ...
            return e.map((e, n) => ({ icon: e, desc: s.value[`reaction${n}`], active: r.value[t] === n }))
          })
        let u
        return (
          Kn(() => {
            Dn(
              ...
              () => {
                ;(async () => {
                  if (a.value) {
                    const { serverURL: e, lang: t, path: n, reaction: r } = l.value,
          ...
          (e, t) =>
            rn(c).length
              ? (Ur(),
                Nr('div', ms, [
                  Zr('div', { class: 'wl-reaction-title', textContent: q(rn(s).reactionTitle) }, null, 8, vs),
                  Zr('ul', ys, [
                    (Ur(!0),
                    Nr(
                      Ir,
                          ...
                          Nr(
                            'li',
                            {
                              ...
                              onClick: e =>
                                (async e => {
                                  if (-1 === i.value) {
                                    const { serverURL: t, lang: n, path: s } = l.value,
                                      a = r.value[s]
                                    ;(i.value = e),
                                      void 0 !== a &&
                                        (await C({
                                        ...
                                        (o.value[a] = Math.max(o.value[a] - 1, 0))),
                                      a !== e &&
                                        (await C({ serverURL: t, lang: n, path: s, type: `reaction${e}` }),
                                        (o.value[e] = (o.value[e] || 0) + 1)),
                                      a === e ? delete r.value[s] : (r.value[s] = e),
                                      (i.value = -1)
                                  }
                                })(t),
                            },
                            [
                              Zr('div', bs, [
                                ...
                                i.value === t
                                  ? (Ur(), Vr(rn(Xo), { key: 0, class: 'wl-reaction-loading' }))
                                  : (Ur(),
                                    Nr(
                                      'div',
                                      { key: 1, class: 'wl-reaction-votes', textContent: q(o.value[t] || 0) },
                                      null,
                                      8,
                                      xs,
                                    )),
                              ]),
                              Zr('div', { class: 'wl-reaction-text', textContent: q(a) }, null, 8, _s),
                            ],
                            10,
                            ws,
                          )
        ...
        return (
          e &&
            Array.prototype.forEach.call(e.length ? e : [e], function (e) {
              return (function (e) {
                if (e && e.nodeName && 'TEXTAREA' === e.nodeName && !As.has(e)) {
                  var t,
                    n = null,
                    ...
                    l =
                      ((t = e.value),
                      function () {
                        o({ testForHeightReduction: '' === t || !e.value.startsWith(t), restoreTextAlign: null }),
                          (t = e.value)
                      }),
                    i = function (t) {
                ...
                function o(t) {
                  ...
                  if (
                    ...
                    var d = r.textAlign
                    'hidden' === r.overflow && (e.style.textAlign = 'start' === d ? 'end' : 'start'),
  ...
  var js = Wn({
      ...
      setup(e, t) {
        ...
        const i = Yt(null),
          ...
          s = Yt([]),
          a = () => {
            const e = Math.floor((i.value.getBoundingClientRect().width + r.gap) / (r.columnWidth + r.gap))
            return e > 0 ? e : 1
          },
          c = async e => {
            var t
            ...
            await kn()
            const n = Array.from((null === (t = i.value) || void 0 === t ? void 0 : t.children) || []).reduce((e, t) =>
        ...
        return (
          ...
          (t, n) => (
            ...
            Nr(
              'div',
              { ref_key: 'wall', ref: i, class: 'wl-gallery', style: U({ gap: `${e.gap}px` }) },
              [
                (Ur(!0),
                Nr(
                  Ir,
                  ...
                  rr(
                    ...
                    (n, r) => (
                      ...
                      Nr(
                        'div',
                        { key: r, class: 'wl-gallery-column', 'data-index': r, style: U({ gap: `${e.gap}px` }) },
                        [
                          (Ur(!0),
                          Nr(
                            Ir,
                                ...
                                Nr(
                                  ...
                                  [
                                    o.value[e.items[n].src]
                                      ? Jr('v-if', !0)
                                      : (Ur(), Vr(rn(Xo), { key: 0, size: 36, style: { margin: '20px auto' } })),
                                    Zr(
                                      'img',
                                      {
                                        ...
                                        loading: 'lazy',
                                        onLoad: p,
                                        onClick: r => t.$emit('insert', `![](${e.items[n].src})`),
                                      },
                                      null,
                                      40,
                                      Os,
        ...
        const i = Fn('config'),
          ...
          T = e => {
            const t = u.value,
              ...
              r = t.selectionEnd || 0,
              l = t.scrollTop
            ;(o.value = t.value.substring(0, n) + e + t.value.substring(r, t.value.length)),
              t.focus(),
          ...
          D = async () => {
            var e, t, n
            const { serverURL: p, lang: d, login: h, wordLimit: f, requiredMeta: g } = i.value
            let m = ''
            i.value.recaptchaV3Key &&
              (m = await (e => {
                const t = hs[e] ?? (hs[e] = ls.load(e, { useRecaptchaNet: !0, autoHideBadge: !0 }))
            ...
            const y = await (async () => {
                ...
                return n
                  ? (parseInt(n.split('.')[0]) >= 13 && (t = t.replace('Windows NT 10.0', 'Windows NT 11.0')), t)
                  : t
              })(),
              w = {
                comment: E.value,
            ...
            if (null !== (e = a.value) && void 0 !== e && e.token)
              (w.nick = a.value.display_name), (w.mail = a.value.email), (w.link = a.value.url)
            else {
              var b, k
              if ('force' === h) return
              if (g.indexOf('nick') > -1 && !w.nick)
                return null !== (b = c.value.nick) && void 0 !== b && b.focus(), alert(z.value.nickError)
              if (
                (g.indexOf('mail') > -1 && !w.mail) ||
                (w.mail && !/^\w(?:[\w._-]*\w)?@(?:\w(?:[\w-]*\w)?\.)*\w+$/.exec(w.mail))
              )
                return null !== (k = c.value.mail) && void 0 !== k && k.focus(), alert(z.value.mailError)
              w.nick || (w.nick = z.value.anonymous)
            }
            if (!w.comment) return void (null === (t = u.value) || void 0 === t || t.focus())
            if (!A.value)
              return alert(
                z.value.wordHint
            ...
            ;(w.comment = Fo(w.comment, v.value.map)),
              l.replyId && l.rootId && ((w.pid = l.replyId), (w.rid = l.rootId), (w.at = l.replyUser)),
              (I.value = !0)
            const $ = {
              serverURL: p,
              lang: d,
            ...
            ;(l.edit
              ...
              : (e => {
                  ...
                  return (
                    ...
                    fetch(`${t}/comment?lang=${n}`, { method: 'POST', headers: i, body: JSON.stringify(l) }).then(e =>
                      e.json(),
                    )
                  )
                })($)
              ...
              .then(e => {
                ...
                r('submit', e.data),
                  ...
                  (null === (t = l.edit) || void 0 === t ? void 0 : t.objectId) && r('cancelEdit')
              })
              .catch(e => {
          ...
          H = e => {
            ...
            ;(e => {
                ...
                new Promise(e => {
                  const t = n => {
                    ...
                    r &&
                      ...
                      'userInfo' === r.type &&
                      r.data.token &&
                      (null != i && i.close(), window.removeEventListener('message', t), e(r.data))
                  }
              ...
              ;(a.value = e),
                (e.remember ? localStorage : sessionStorage).setItem('WALINE_USER', JSON.stringify(e)),
                r('log')
            })
          },
          B = () => {
          ...
          W = e => {
            ...
            null == s || s.postMessage({ type: 'TOKEN', data: a.value.token }, '*')
          },
          Z = e => {
            var t, n, r, l
            ;(null !== (t = d.value) && void 0 !== t && t.contains(e.target)) ||
              (null !== (n = h.value) && void 0 !== n && n.contains(e.target)) ||
              (w.value = !1),
              (null === (r = f.value) || void 0 === r ? void 0 : r.contains(e.target)) ||
                (null === (l = g.value) || void 0 === l ? void 0 : l.contains(e.target)) ||
                (b.value = !1)
          },
          Q = async e => {
            var t
            const { scrollTop: n, clientHeight: r, scrollHeight: l } = e.target,
              o = (r + n) / l,
              s = i.value.search,
              a = (null === (t = m.value) || void 0 === t ? void 0 : t.value) || ''
            o < 0.9 ||
              $.loading ||
              L.value ||
              (($.loading = !0),
              (s.more && $.list.length ? await s.more(a, $.list.length) : await s.search(a)).length
                ? ($.list = [
                    ...$.list,
                    ...(s.more && $.list.length ? await s.more(a, $.list.length) : await s.search(a)),
                  ])
                : (L.value = !0),
              ($.loading = !1),
              setTimeout(() => {
        ...
        return (
          Kn(() => {
            ...
            document.body.addEventListener('click', Z),
              ...
              null !== (e = l.edit) && void 0 !== e && e.objectId && (o.value = l.edit.orig),
              Dn(b, async e => {
                if (!e) return
                const t = i.value.search
                m.value && (m.value.value = ''),
                  ($.loading = !0),
                  ($.list = t.default ? await t.default() : await t.search('')),
                  ($.loading = !1)
              }),
              Dn(
                () => o.value,
                e => {
                  ...
                  ;(E.value = e),
                    (x.value = ((e, t) => {
                      ...
                      if ((To.setOptions({ highlight: r || void 0, breaks: !0, smartLists: !0, smartypants: !0 }), l)) {
                        const e = (e => [
                          {
                            name: 'blockMath',
                            level: 'block',
                    ...
                    })(e, { emojiMap: v.value.map, highlighter: t, texRenderer: n })),
                    (_.value = (e => {
                      var t, n
                      return (
                        ((null === (t = (e => e.match(/[\w\d\s,.\u00C0-\u024F\u0400-\u04FF]+/giu))(e)) || void 0 === t
                          ? void 0
                          : t.reduce((e, t) => e + ('' === t.trim() ? 0 : t.trim().split(/\s+/u).length), 0)) || 0) +
                        ((null === (n = (e => e.match(/[\u4E00-\u9FD5]/gu))(e)) || void 0 === n ? void 0 : n.length) ||
                          0)
                      )
                    })(e)),
              ...
              Dn(
                ...
                e => {
                  ...
                  Promise.all(
                    ...
                    return (
                      e.forEach(e => {
                        const { name: n, folder: r, icon: l, prefix: i, type: o, items: s } = e
                        t.tabs.push({
                          name: n,
                          icon: Zi(l, r, i, o),
                          items: s.map(e => {
          ...
          Jn(() => {
            document.body.removeEventListener('click', Z), window.removeEventListener('message', G)
          }),
          (t, n) => {
            var r, l
            return (
              Ur(),
              Nr('div', Us, [
                'disable' === rn(i).login || !rn(O) || (null !== (r = e.edit) && void 0 !== r && r.objectId)
                  ? Jr('v-if', !0)
                  : (Ur(),
                    Nr('div', Ps, [
                      Zr('div', Ms, [
                        Zr(
                          'button',
                          { type: 'submit', class: 'wl-logout-btn', title: rn(z).logout, onClick: B },
                          [Qr(rn(Do), { size: 14 })],
                          8,
                          Fs,
                        ),
                        Zr(
                          ...
                          [Zr('img', { src: rn(a).avatar, alt: 'avatar' }, null, 8, Vs)],
                          8,
                          Ns,
                        ),
                      ]),
                ...
                Zr('div', Hs, [
                  'force' !== rn(i).login && rn(i).meta.length && !rn(O)
                    ? (Ur(),
                      Nr(
                        'div',
                        { key: 0, class: V(['wl-header', `item${rn(i).meta.length}`]) },
                        [
                          (Ur(!0),
                          Nr(
                            Ir,
                            ...
                            rr(
                              ...
                              e => (
                                Ur(),
                                Nr('div', { key: e, class: 'wl-header-item' }, [
                                  Zr(
                                    'label',
                                    {
                                      for: `wl-${e}`,
                                      textContent: q(
                                        rn(z)[e] +
                                          (rn(i).requiredMeta.includes(e) || !rn(i).requiredMeta.length
                                            ? ''
                                            : `(${rn(z).optional})`),
                                      ),
                                    },
                                  ...
                                  Xn(
                                    Zr(
                                      'input',
                                      {
                                        ...
                                        'onUpdate:modelValue': t => (rn(s)[e] = t),
                  ...
                  Xn(
                    Zr(
                      'textarea',
                      {
                        ...
                        ref_key: 'editorRef',
                        ref: u,
                        'onUpdate:modelValue': n[0] || (n[0] = e => (Xt(o) ? (o.value = e) : null)),
                        class: 'wl-editor',
                        placeholder: e.replyUser ? `@${e.replyUser}` : rn(z).placeholder,
                        onKeydown: U,
                        onDrop: M,
                        onPaste: F,
                      },
                  ...
                  Xn(
                    Zr(
                      ...
                      [
                        ...
                        Zr('div', { class: 'wl-content', innerHTML: x.value }, null, 8, Ks),
                      ],
                      512,
                    ),
                    [[Wl, k.value]],
                  ...
                  Zr('div', Gs, [
                    Zr('div', Js, [
                      ...
                      Xn(
                        Zr(
                          'button',
                          {
                            ...
                            title: rn(z).emoji,
                            onClick: n[1] || (n[1] = e => (w.value = !w.value)),
                          },
                          [Qr(rn(Bo))],
                          10,
                          Ys,
                      ...
                      rn(j)
                        ? (Ur(),
                          Nr(
                            'label',
                            { key: 1, for: 'wl-image-upload', class: 'wl-action', title: rn(z).uploadImage },
                            [Qr(rn(Wo))],
                            8,
                            ta,
                          ))
                      ...
                      Zr(
                        'button',
                        {
                          ...
                          title: rn(z).preview,
                          onClick: n[3] || (n[3] = e => (k.value = !k.value)),
                        },
                        [Qr(rn(Zo))],
                        10,
                        na,
                    ...
                    Zr('div', ra, [
                      Zr('div', la, [
                        ...
                        rn(i).wordLimit
                          ? (Ur(),
                            Nr('span', ia, [
                              Gr('  /  '),
                              Zr('span', { class: V({ illegal: !A.value }), textContent: q(C.value) }, null, 10, oa),
                            ]))
                          : Jr('v-if', !0),
                        Gr('  ' + q(rn(z).word), 1),
                      ]),
                      'disable' === rn(i).login || rn(O)
                        ...
                        : (Ur(),
                          Nr(
                            'button',
                            { key: 0, type: 'button', class: 'wl-btn', onClick: H, textContent: q(rn(z).login) },
                            null,
                            8,
                            sa,
                          )),
                          ...
                          Nr(
                            ...
                            [
                              I.value
                                ...
                                : (Ur(), Nr(Ir, { key: 1 }, [Gr(q(rn(z).submit), 1)], 64)),
                            ],
                            8,
                            aa,
                          ))
                    ...
                    Zr(
                      'div',
                      { ref_key: 'gifPopupRef', ref: g, class: V(['wl-gif-popup', { display: b.value }]) },
                      [
                        Zr(
                          'input',
                          {
                        ...
                        $.loading ? (Ur(), Nr('div', ua, [Qr(rn(Xo), { size: 30 })])) : Jr('v-if', !0),
                      ],
                      2,
                    ),
                    Zr(
                      'div',
                      { ref_key: 'emojiPopupRef', ref: h, class: V(['wl-emoji-popup', { display: w.value }]) },
                      [
                        (Ur(!0),
                        Nr(
                          Ir,
                                        ...
                                        Nr(
                                          ...
                                          rr(
                                            ...
                                            e => (
                                              ...
                                              Nr(
                                                'button',
                                                { key: e, type: 'button', title: e, onClick: t => T(`:${e}:`) },
                                                [
                                                  w.value
                                                    ? (Ur(),
                                                      Nr(
                                  ...
                                  (e, t) => (
                                    ...
                                    Nr(
                                      'button',
                                      {
                                        key: e.name,
                                        type: 'button',
                                        class: V(['wl-tab', { active: y.value === t }]),
                                        onClick: e => (y.value = t),
                                      },
                                      [
                                        Zr(
                ...
                e.replyId || (null !== (l = e.edit) && void 0 !== l && l.objectId)
                  ? (Ur(),
                    Nr(
                      'button',
                      {
                        ...
                        onClick: n[6] || (n[6] = n => t.$emit(e.replyId ? 'cancelReply' : 'cancelEdit')),
                      },
                      [Qr(rn(Do), { size: 24 })],
                      8,
                      va,
  ...
  var Wa = Cs(
    Wn({
      __name: 'CommentCard',
      props: { comment: null, edit: { default: null }, rootId: null, reply: { default: null } },
      ...
      setup(e) {
        const t = e,
                ...
                'requestAnimationFrame' === n
                  ? (function (e) {
                      ...
                      let i = 0,
                        o = null
                      function s(t) {
                        l.value && r && (e({ delta: t - i, timestamp: t }), (i = t), (o = r.requestAnimationFrame(s)))
                      }
                      function a() {
                        !l.value && r && ((l.value = !0), (o = r.requestAnimationFrame(s)))
                      }
                      function c() {
                        ;(l.value = !1), null != o && r && (r.cancelAnimationFrame(o), (o = null))
                      }
                      return n && a(), ni(c), { isActive: Nt(l), pause: c, resume: a }
                    })(l, { immediate: !0 })
                  : (function (e) {
                      ...
                      function c() {
                        const n = Yl(t)
                        n <= 0 || ((o.value = !0), l && e(), s(), (i = setInterval(e, n)))
                      }
                      return (
                        r && Kl && c(),
                        (Xt(t) || Gl(t)) &&
          ...
          d = hl(() => t.comment.user_id && o.value.objectId === t.comment.user_id),
          h = hl(() => {
            var e
            return t.comment.objectId === (null === (e = t.reply) || void 0 === e ? void 0 : e.objectId)
          }),
          f = hl(() => {
            var e
            return t.comment.objectId === (null === (e = t.edit) || void 0 === e ? void 0 : e.objectId)
          })
        return (t, r) => {
          var l
          const i = (function (e, t) {
              ...
              (function (e, t) {
                ...
                if (r) {
                  ...
                  if (e === er) {
                    ...
                    if (e && (e === t || e === xe(t) || e === Ce(xe(t)))) return l
                  }
          ...
          return (
            ...
            Nr(
              ...
              [
                Zr('div', ka, [
                  e.comment.avatar ? (Ur(), Nr('img', { key: 0, src: e.comment.avatar }, null, 8, xa)) : Jr('v-if', !0),
                  e.comment.type ? (Ur(), Vr(rn(Jo), { key: 1 })) : Jr('v-if', !0),
                ]),
                Zr('div', _a, [
                  Zr('div', $a, [
                    rn(a)
                      ? (Ur(),
                        Nr(
                          'a',
                          { key: 0, class: 'wl-nick', href: rn(a), target: '_blank', rel: 'noopener noreferrer' },
                          q(e.comment.nick),
                          9,
                          Ca,
                        ))
                    ...
                    'administrator' === e.comment.type
                      ? (Ur(), Nr('span', { key: 2, class: 'wl-badge', textContent: q(rn(s).admin) }, null, 8, Aa))
                      : Jr('v-if', !0),
                    e.comment.label
                      ? (Ur(), Nr('span', { key: 3, class: 'wl-badge', textContent: q(e.comment.label) }, null, 8, Ra))
                      : Jr('v-if', !0),
                    e.comment.sticky
                      ? (Ur(), Nr('span', { key: 4, class: 'wl-badge', textContent: q(rn(s).sticky) }, null, 8, Ea))
                      : Jr('v-if', !0),
                    void 0 !== e.comment.level && e.comment.level >= 0
                      ? (Ur(),
                        Nr(
                          'span',
                          {
                            ...
                            textContent: q(rn(s)[`level${e.comment.level}`] || `Level ${e.comment.level}`),
                          },
                          null,
                          10,
                          Ia,
                      ...
                      : Jr('v-if', !0),
                    Zr('span', { class: 'wl-time', textContent: q(rn(u)) }, null, 8, La),
                    Zr('div', za, [
                      rn(p) || rn(d)
                        ? (Ur(),
                          Nr(
                            'button',
                            {
                              ...
                              type: 'button',
                              class: 'wl-edit',
                              onClick: r[0] || (r[0] = () => t.$emit('edit', e.comment)),
                            },
                            [Qr(rn(Go))],
                          ))
                        : Jr('v-if', !0),
                        ...
                        ? (Ur(),
                          Nr(
                            'button',
                            {
                              ...
                              type: 'button',
                              class: 'wl-delete',
                              onClick: r[1] || (r[1] = n => t.$emit('delete', e.comment)),
                            },
                            [Qr(rn(Ho))],
                          ))
                        : Jr('v-if', !0),
                      Zr(
                        'button',
                        {
                          ...
                          onClick: r[2] || (r[2] = n => t.$emit('like', e.comment)),
                        },
                        [
                          Qr(rn(qo), { active: rn(c) }, null, 8, ['active']),
                          'like' in e.comment
                            ? (Ur(), Nr('span', { key: 0, textContent: q(e.comment.like) }, null, 8, ja))
                            : Jr('v-if', !0),
                        ],
                        8,
                        Oa,
                      ...
                      Zr(
                        'button',
                        {
                          ...
                          onClick: r[3] || (r[3] = n => t.$emit('reply', rn(h) ? null : e.comment)),
                        },
                        [Qr(rn(Ko))],
                        10,
                        Ta,
                  ...
                  Zr('div', Ua, [
                    e.comment.addr
                      ? (Ur(),
                        Nr(
                          'span',
                          { key: 0, class: 'wl-addr', 'data-value': e.comment.addr, textContent: q(e.comment.addr) },
                          null,
                          8,
                          Pa,
                        ))
                    ...
                    e.comment.os
                      ? (Ur(),
                        Nr(
                          'span',
                          { key: 2, class: 'wl-os', 'data-value': e.comment.os, textContent: q(e.comment.os) },
                          null,
                          8,
                          Fa,
                        ))
                  ...
                  rn(f)
                    ? Jr('v-if', !0)
                    : (Ur(), Nr('div', { key: 0, class: 'wl-content', innerHTML: e.comment.comment }, null, 8, Na)),
                  rn(p) && !rn(f)
                    ? (Ur(),
                      Nr('div', Va, [
                        Zr('span', Da, [
                            ...
                            rr(n, n =>
                              Zr(
                                'button',
                                {
                                  ...
                                  onClick: r => t.$emit('status', { status: n, comment: e.comment }),
                          ...
                          ? (Ur(),
                            Nr(
                              'button',
                              {
                                ...
                                onClick: r[4] || (r[4] = n => t.$emit('sticky', e.comment)),
                              },
                              q(e.comment.sticky ? rn(s).unsticky : rn(s).sticky),
                              1,
                            ))
                          : Jr('v-if', !0),
                      ]))
                  ...
                  rn(h) || rn(f)
                    ? (Ur(),
                      Nr(
                        'div',
                        { key: 2, class: V({ 'wl-reply-wrapper': rn(h), 'wl-edit-wrapper': rn(f) }) },
                        [
                          Qr(
                            wa,
                            {
                              edit: e.edit,
                              'reply-id': null === (l = e.reply) || void 0 === l ? void 0 : l.objectId,
                              'reply-user': e.comment.nick,
                              'root-id': e.rootId,
                              onLog: r[5] || (r[5] = e => t.$emit('log')),
                              onCancelReply: r[6] || (r[6] = e => t.$emit('reply', null)),
                              onCancelEdit: r[7] || (r[7] = e => t.$emit('edit', null)),
                              onSubmit: r[8] || (r[8] = e => t.$emit('submit', e)),
                            },
                            null,
                            8,
                            ...
                            n => (
                              ...
                              Vr(
                                i,
                                {
                                  ...
                                  onDelete: r[10] || (r[10] = e => t.$emit('delete', e)),
                                  onEdit: r[11] || (r[11] = e => t.$emit('edit', e)),
                                  onLike: r[12] || (r[12] = e => t.$emit('like', e)),
                                  onReply: r[13] || (r[13] = e => t.$emit('reply', e)),
                                  onStatus: r[14] || (r[14] = e => t.$emit('status', e)),
                                  onSticky: r[15] || (r[15] = e => t.$emit('sticky', e)),
                                  onSubmit: r[16] || (r[16] = e => t.$emit('submit', e)),
                                },
                                null,
                                8,
  ...
  var ac = Wn({
      ...
      setup(e) {
          ...
          y = hl(() =>
            (e => {
              let {
                ...
                lang: u = 'undefined' == typeof navigator ? 'en-US' : navigator.language,
                locale: p,
                emoji: h = r,
              ...
              return {
                serverURL: I(t),
                path: A(c),
                locale: { ...(k[u] || k[l]), ...('object' == typeof p ? p : {}) },
                wordLimit: L(y),
                meta: n(f),
                requiredMeta: n(g),
                imageUploader: z(w, o),
        ...
        !(function (e) {
          let t = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : {}
          const n = Yt(!1),
            { document: r = wi, immediate: l = !0, manual: i = !1, id: o = 'vueuse_styletag_' + ++Vi } = t,
            s = Yt(e)
          let a = () => {}
          const c = () => {
              if (!r) return
              ...
              e.isConnected ||
                ((e.type = 'text/css'), (e.id = o), t.media && (e.media = t.media), r.head.appendChild(e)),
                n.value ||
                  ((a = Dn(
                    s,
                    t => {
        ...
        const j = e => {
            ...
            ;(f.value = 'loading'),
              null !== (t = E) && void 0 !== t && t(),
              (e => {
                let { serverURL: t, lang: n, path: r, page: l, pageSize: i, sortBy: o, signal: s, token: a } = e
                const c = {}
                return (
                  a && (c.Authorization = `Bearer ${a}`),
                  fetch(`${t}/comment?path=${encodeURIComponent(r)}&pageSize=${i}&page=${l}&lang=${n}&sortBy=${o}`, {
                    signal: s,
                    headers: c,
                  })
                    .then(e => e.json())
                ...
                page: e,
                signal: o.signal,
                token: null === (n = p.value) || void 0 === n ? void 0 : n.token,
              })
                .then(t => {
                  ;(f.value = 'success'),
                    (g.value = t.count),
          ...
          N = async e => {
            ...
            await S({
              serverURL: l,
              lang: i,
              token: null === (t = p.value) || void 0 === t ? void 0 : t.token,
              objectId: n.objectId,
              comment: { status: r },
            }),
              (n.status = r)
            ...
            await (e => {
              ...
              b.value.some((e, t) =>
                e.objectId === n
                  ...
                  : e.children.some(
                      (r, l) => r.objectId === n && ((b.value[t].children = e.children.filter((e, t) => t !== l)), !0),
                    ),
              )
          },
          B = async e => {
            ...
            await S({
              ...
              i
                ...
                : ((h.value = [...h.value, l]), h.value.length > 50 && (h.value = h.value.slice(-50))),
        ...
        return (
          ...
          (e, t) => (
            ...
            Nr('div', Za, [
              Qr(Ss),
              x.value ? Jr('v-if', !0) : (Ur(), Vr(wa, { key: 0, onLog: U, onSubmit: F })),
              Zr('div', Qa, [
                Zr('div', Ka, [
                  g.value
                    ? (Ur(), Nr('span', { key: 0, class: 'wl-num', textContent: q(g.value) }, null, 8, Ga))
                    : Jr('v-if', !0),
                  Gr(' ' + q(rn(R).comment), 1),
                ]),
                Zr('ul', Ja, [
              ...
              'error' === f.value
                ? (Ur(),
                  Nr('div', ec, [
                    Zr(
                      'button',
                      { type: 'button', class: 'wl-btn', onClick: U, textContent: q(rn(R).refresh) },
                      null,
                      8,
                      tc,
                    ),
                    ...
                    [
                      'loading' === f.value
                        ...
                        ? m.value < v.value
                          ...
                          : Jr('v-if', !0)
                        : (Ur(), Nr('div', { key: 1, class: 'wl-empty', textContent: q(rn(R).sofa) }, null, 8, rc)),
                    ],
                    64,
                  )),
              rn(y).copyright
                ? (Ur(), Nr('div', oc, [Gr(' Powered by '), sc, Gr(' v' + q(rn(qa)), 1)]))
                : Jr('v-if', !0),
            ])
          )
        )
    ...
    pc = e => {
      ...
      const o = new AbortController(),
        ...
        c = e =>
          (e => {
            let { serverURL: t, lang: n, paths: r, signal: l } = e
            return $({ serverURL: t, lang: n, paths: r, type: ['time'], signal: l }).then(e =>
              Array.isArray(e) ? e : [e],
            )
          })({ serverURL: I(t), paths: e.map(e => No(e) || n), lang: i, signal: o.signal })
            .then(t => uc(t, e))
            .catch(Qi)
      if (l) {
        const e = s.filter(e => !a(e)),
          r = s.filter(a)
        ;((u = { serverURL: I(t), path: n, lang: i }), C({ ...u, type: 'time', action: 'inc' })).then(t =>
  ...
  ;(e.UserList = e => {
    let { el: t, serverURL: n, count: r, locale: i, lang: o = navigator.language, mode: s = 'list' } = e
    const a = Ki(t),
          ...
          (a.innerHTML = `<ul class="wl-user-${s}">${e
            .map((e, t) =>
              [
                ...
                e.nick,
                e.level && `<span class="wl-badge">${i ? i[`level${e.level}`] : `Level ${e.level}`}</span>`,
    ...
    (e.RecentComments = e => {
      ...
      return (e => {
        ...
        return (
          ...
          fetch(`${t}/comment?type=recent&count=${r}&lang=${n}`, { signal: l, headers: o }).then(e => e.json())
        )
      })({
        serverURL: r,
        count: l,
    ...
    (e.init = e => {
      let { el: t = '#waline', path: n = window.location.pathname, comment: r = !1, pageview: l = !1, ...i } = e
      const o = t ? Ki(t) : null
          ...
          ? (function () {
              ...
              return (
                (e.mount = n => {
                  ...
                  ce(l) || l.render || l.template || (l.template = r.innerHTML), (r.innerHTML = '')
      ...
      const u = Nn(() => {
          a.comment &&
            Vo({ serverURL: s.serverURL, path: a.path, selector: 'string' == typeof a.comment ? a.comment : void 0 })
        }),
        p = Nn(() => {
          a.pageview &&
            pc({ serverURL: s.serverURL, path: a.path, selector: 'string' == typeof a.pageview ? a.pageview : void 0 })
        })
      return {
        el: o,
        update: function () {
